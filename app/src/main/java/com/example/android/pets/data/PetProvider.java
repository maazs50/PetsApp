...
sUriMatcher.addURI(PetContract.CONTENT_AUTHORITY,PetContract.PATH_PETS,PETS);
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if(gender == null||PetEntry.isValidGender(gender)==false){
        ...
        //Notify all listners that the data has changed for the contentURI
...
int rowsDeleted;
        ...
        switch (match){
            ...
            case PET_ID:
                ...
                selectionArgs=new String[]{String.valueOf(ContentUris.parseId(uri))};
                rowsDeleted= database.delete(PetEntry.TABLE_NAME,selection,selectionArgs);
                Log.i("Id",selection+ " deleted");
                break;


            default: throw new IllegalArgumentException("Unable to delete the entries"+uri);
